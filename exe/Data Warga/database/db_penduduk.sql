...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Jan 2020 pada 05.07
...
(12, '3322395865001234', 'KRISNA', 'LAKI-LAKI', 'PEMALANG', '2005-01-05', 'HINDU', 'SMP/SEDERAJAT', 'PELAJAR', 'JL.NASIONAL 2', 'TETAP'),
(13, '3521356799000432', 'RIO HARYANTO', 'LAKI-LAKI', 'JAKARTA', '2004-01-24', 'KRISTEN', 'SLTP/SEDERAJAT', 'PELAJAR', 'JL.PAHLAWAN', 'TETAP');
...
(8, '3322395865001234', 'BELUM KAWIN', 'ANAK', 'INDONESIA', '-', 'ANTO', 'SRI MULYANI');
...
--
ALTER TABLE `tiuran`
  MODIFY `kode_t` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `tstatus`
  MODIFY `kodestat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- Ketidakleluasaan untuk tabel `tiuran`
--
ALTER TABLE `tiuran`
  ADD CONSTRAINT `tiuran_ibfk_1` FOREIGN KEY (`nik`) REFERENCES `tpenduduk` (`nik`);
